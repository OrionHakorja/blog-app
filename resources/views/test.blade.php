...
<header>
    <div class="container">
        <h1>Blog Frontpage</h1>
        <nav>
            <ul>
                <!-- If the user is authenticated -->
                @auth
                    <li><a href="/">Home</a></li>
                    <li><a href="{{route('blogs.create')}}">Create a blog</a></li>
                    ...
                    <li>
                        <form action="{{route('blogs.search')}}" method="GET" class="search-form">
                            @csrf
...
<footer>
    <div class="container">
        @guest()
            <p>&copy; 2024 My Blog. All rights reserved. PS:Login and register to create a blog</p>
        @endguest
        @auth()
